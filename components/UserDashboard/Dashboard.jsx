		...
		<div className="min-h-screen ">
			<div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
					{stats.map((stat, index) => (
						<Link key={index} href={stat.href}>
							<Card className="border shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 cursor-pointer">
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
					{quickActions.map((action, index) => (
						<Link key={index} href={action.href}>
							<Card className="border dark:border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 cursor-pointer overflow-hidden">
				...
				<div className="grid lg:grid-cols-3 gap-8 mb-8">
							...
							<CardContent>
								<div className="space-y-4">
									{upcomingEvents.map((event) => (
										<div
											key={event.id}
											className="flex items-center space-x-4 p-4 border rounded-xl hover:bg-gray-100 dark:hover:bg-gray-900 transition-all duration-300"
										>
					...
					{/* Loyalty Progress */}
					<div>
						{/* <Card className="border shadow-lg mb-6 overflow-hidden">
							...
							{recommendations.map((event) => (
								...
								>
									<div className="relative">
										...
										/>
										<Badge className="absolute top-3 left-3 bg-red-500 text-white border">{event.discount}</Badge>
										<Badge className="absolute top-3 right-3 bg-purple-500 text-white border">{event.badge}</Badge>
										<Button
											size="icon"
											variant="ghost"
